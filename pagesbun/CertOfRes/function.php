...
if(isset($_POST['btn_add'])){
    ...
    $chkdup = mysqli_query($con,"SELECT * from tblrecidencybun where resident = ".$ddl_resident." ");
    ...
    if($rows == 0){
        $query = mysqli_query($con,"INSERT INTO tblrecidencybun (resident,purpose,purok) 
...
if(isset($_POST['btn_save']))
{
    ...
    $update_query = mysqli_query($con,"UPDATE tblrecidencybun set purpose = '".$txt_edit_purpose."', purok = '".$txt_edit_purok."' ") or die('Error: ' . mysqli_error($con));
...
if(isset($_POST['btn_delete']))
{
    if(isset($_POST['chk_delete']))
    {
        ...
        {
            $delete_query = mysqli_query($con,"DELETE from tblrecidencybun where id = '$value' ") or die('Error: ' . mysqli_error($con));
