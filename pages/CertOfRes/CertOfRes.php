                        ...
                        <div class="box-body table-responsive">
                            <form method="post">
                                <table id="table" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                       <?php
                                        $squery = mysqli_query($con, "SELECT *, CONCAT(lname, ', ', fname, ' ', mname) as resident, p.id as pid  FROM tblrecidency p left join tblresident r on r.id = p.resident") or die('Error: ' . mysqli_error($con));
