    ...
    <div class="modal-content">
        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    <label>Email:</label>
                    <input name="txt_edit_email" class="form-control input-sm" type="email" placeholder="Ex: juan@sample.com" required/>
                </div>
                <div class="form-group">
                    <label>Password: </label>
                    <input name="txt_edit_pass" class="form-control input-sm" type="password" placeholder="Password" required/>
                </div>
                <div class="form-group">
                    <label>Confirm Password: </label>
                    <input name="txt_edit_compass" class="form-control input-sm" type="password" placeholder="Confirm Password" required/>
                </div>
            </div>
        </div>
        </div>
