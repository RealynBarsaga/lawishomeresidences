...
<body class="skin-black">
    ...
    <div style="background: black;">
        <div class="col-xs-4 col-sm-3 col-md-2" style="background: white; margin-right: -124px;">
            <img src="../../img/bn.png" style="width:80%; height:140px; margin-top: -7px;" />
        </div>
        <div class="col-xs-7 col-sm-6 col-md-8" style="background: white;">
            <div class="pull-left" style="font-size: 16px; margin-left: 100px; font-family: 'Courier New', Courier;">
                <center>
                    ...
                    <b>
                        <p style="font-size: 25px; font-family: 'Courier New', Courier;">BARANGAY BUNAKAN</p>
                    </b>
                </center>
    ...
    <div class="col-xs-12 col-md-12">
        ...
        <p style="text-indent:40px; text-align: justify;">
            ...
            $squery = mysqli_query($con, "SELECT * FROM tblbunakan WHERE id = $id LIMIT 1");
        ...
        <p style="font-size: 12px; font-family: 'Courier New', Courier;">
            ...
            $squery = mysqli_query($con, "SELECT * FROM tblclearbun WHERE residentid = '$resident_id' LIMIT 1") or die('Error: ' . mysqli_error($con));
    ...
    <p style="text-align: center;">
        <strong style="font-size: 18px; margin-right: 5px;">HON. BASILIO S. DUCAY</strong><br>
