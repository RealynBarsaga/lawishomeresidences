...
if(isset($_POST['btn_add'])){
    ...
    $chkdup = mysqli_query($con,"SELECT * from tblclearance where residentid = ".$ddl_resident." ");
    ...
    if($rows == 0){
        $query = mysqli_query($con,"INSERT INTO tblclearance (clearanceNo,residentid,purpose,orNo,samount,dateRecorded,recordedBy) 
