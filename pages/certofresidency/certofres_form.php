        ...
        <div class="col-xs-12 col-sm-6 col-md-8" style="" >
            <div style=" background: black;" >
                <div class="col-xs-4 col-sm-6 col-md-3" style="background: white; margin-right:10px; border: 2px solid black;">
                    <center><image src="../../img/pajo.jpg" style="width:90%;height:164px;"/></center>
                ...
                <div class="col-xs-7 col-sm-5 col-md-8" style="background: white;  ">
                    ...
                    <div class="pull-right" style="border: 2px solid black;">
                       <?php $qry1=mysqli_query($con,"SELECT * from tbltabagak r left join tblclearance c on c.residentid = r.id where residentid = '".$_GET['resident']."' and clearanceNo = '".$_GET['clearance']."' ");
                    ...
                    <div class="col-xs-12 col-md-12">
                        ...
                        <?php
                            $qry=mysqli_query($con,"SELECT * from tbltabagak r left join tblclearance c on c.residentid = r.id where residentid = '".$_GET['resident']."' and clearanceNo = '".$_GET['clearance']."' ");
                            while($row = mysqli_fetch_array($qry)){
                    ...
                    <div class="col-md-5 col-xs-4" style="float:right;margin-top: -425px;margin-right: -60px;">
                        ...
                        <p style="margin-right: -40px;">Tax Payer's Signature</p>
                    </div>
                </div>
