...
<head>
    ...
    if (!isset($_SESSION['userid'])) {
        header('Location: ../../pagesbun/login.php');
        exit; // Ensure no further execution after redirect
    }
    include('../../pagesbun/head_css.php'); // Load necessary CSS files
    ?>
</head>
<body class="skin-black">
    <!-- header logo: style can be found in header.less -->
    <?php include "../../connection.php"; ?>
    <?php include('../../pagesbun/header.php'); ?>

    <div class="wrapper row-offcanvas row-offcanvas-left">
        <!-- Left side column. contains the logo and sidebar -->
        <?php include('../../pagesbun/sidebar-left.php'); ?>
                            ...
                            <form method="post">
                                <table id="table" class="table table-bordered table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        $stmt = $con->prepare("SELECT *, h.id as id, CONCAT(r.lname, ', ', r.fname, ' ', r.mname) as name FROM tblhouseholdbun h LEFT JOIN tblbunakan r ON r.id = h.headoffamily");
                                        $stmt->execute();
