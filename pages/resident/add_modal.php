                        ...
                        <div class="container-fluid">
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="txt_age" id="txt_age" class="form-control input-sm input-size" type="text" placeholder="Age" readonly />
                                </div>

                                <div class="form-group">
                                    <label class="control-label">Birthdate:</label>
                                    <input name="txt_bdate" id="txt_bdate" class="form-control input-sm input-size" type="date" placeholder="Birthdate" />
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <input name="txt_purok" class="form-control input-sm input-size" type="text" placeholder="Purok" />
                                </div>
                            ...
                            <div class="col-md-6 col-sm-12">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="txt_lightning" class="form-control input-sm input-size" style="width: 433px;">
...
<script type="text/javascript">
    ...
    $(document).ready(function() {
        ...
        $('#txt_bdate').attr('min', startDate);
        $('#txt_bdate').attr('max', endDate);
    });
</script>
